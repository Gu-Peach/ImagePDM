...
class AnnotationEditorUIManager {
  ...
  get highlightColors() {
    return shadow(
      ...
      this.#X
        ? new Map(
            this.#X.split(",").map((t) => t.split("=").map((t) => t.trim()))
          )
        : null
    );
  }
  ...
  showAllEditors(t, e, i = !1) {
    ...
    (this.#lt?.get(m.HIGHLIGHT_SHOW_ALL) ?? !0) !== e &&
      this.#Ft([[m.HIGHLIGHT_SHOW_ALL, e]]);
  }
  enableWaiting(t = !1) {
    if (this.#Z !== t) {
      this.#Z = t;
  ...
  renderAnnotationElement(t) {
    ...
    i &&
      (this.#nt !== g.NONE || i.hasBeenModified) &&
...
class AltText {
  ...
  async render() {
    const t = (this.#Nt = document.createElement("button"));
    t.className = "altText";
    t.tabIndex = "0";
    ...
    if (this.#Vt) {
      t.classList.add("new");
      t.setAttribute("data-l10n-id", AltText.#$t.missing);
      e.setAttribute("data-l10n-id", AltText.#$t["missing-label"]);
    } else {
  ...
  finish() {
    if (this.#Nt) {
      this.#Nt.focus({ focusVisible: this.#Ut });
      this.#Ut = !1;
    }
  }
  isEmpty() {
    return this.#Vt ? null === this.#o : !this.#o && !this.#Ot;
  }
  hasData() {
    return this.#Vt ? null !== this.#o || !!this.#Wt : this.isEmpty();
  }
  get guessedText() {
    return this.#Wt;
  }
  async setGuessedText(t) {
    if (null === this.#o) {
      this.#Wt = t;
      this.#Gt = await AltText._l10n.get(
  ...
  get data() {
    return { altText: this.#o, decorative: this.#Ot };
  }
  set data({
    altText: t,
    decorative: e,
  ...
  async #Xt() {
    ...
    if (this.#Vt) {
      ...
      t.setAttribute("data-l10n-id", AltText.#$t[this.#qt]);
      this.#Bt?.setAttribute("data-l10n-id", AltText.#$t[`${this.#qt}-label`]);
      if (!this.#o) {
        this.#Ht?.remove();
        return;
      }
    ...
    let e = this.#Ht;
    if (!e) {
      this.#Ht = e = document.createElement("span");
      e.className = "tooltip";
...
class AnnotationEditor {
  ...
  translate(t, e) {
    this.#me(this.parentDimensions, t, e);
  }
  translateInPage(t, e) {
    this.#ne ||= [this.x, this.y];
    this.#me(this.pageDimensions, t, e);
  ...
  fixDims() {
    ...
    this.#Jt || n || (t.height = `${((100 * parseFloat(e)) / r).toFixed(2)}%`);
  }
  ...
  #Ae() {
    ...
    for (const i of t) {
      ...
      t.addEventListener("pointerdown", this.#ve.bind(this, i), { signal: e });
      t.addEventListener("contextmenu", noContextMenu, { signal: e });
      t.tabIndex = -1;
    }
  ...
  #ye(t, e) {
    ...
    [_, E] =
      ((C = _ / i), (S = E / s), [c[0] * C + c[2] * S, c[1] * C + c[3] * S]);
    var C, S;
    if (g) {
      const t = Math.hypot(r, o);
      w = x = Math.max(
        Math.min(
          Math.hypot(b[0] - f[0] - _, b[1] - f[1] - E) / t,
          1 / r,
          1 / o
        ),
        l / r,
  ...
  async addEditToolbar() {
    if (this._editToolbar || this.#re) return this._editToolbar;
  ...
  pointerdown(t) {
    ...
    if (0 !== t.button || (t.ctrlKey && e)) t.preventDefault();
      ...
      this.#se = !0;
      this._isDraggable ? this.#_e(t) : this.#Ee(t);
    }
  }
  get isSelected() {
    ...
    if (e) {
      ...
      const pointerMoveCallback = (t) => {
        const { clientX: e, clientY: i } = t,
          [s, n] = this.screenToPageTranslation(e - this.#he, i - this.#de);
        this.#he = e;
        this.#de = i;
  ...
  remove() {
    ...
    if (this.#le) {
      clearTimeout(this.#le);
      this.#le = null;
    }
    this.#ge();
    this.removeEditToolbar();
    if (this.#ce) {
      for (const t of this.#ce.values()) clearTimeout(t);
      this.#ce = null;
    }
    this.parent = null;
  }
  ...
  keydown(t) {
    ...
    if (!this.#Yt) {
      this.#Yt = Array.from(e);
      const t = this.#Ce.bind(this),
        i = this.#Se.bind(this),
    ...
    if (n !== s) {
      ...
      let t = 0;
      for (const i of e) {
        const e = this.#Yt[t++].getAttribute("data-resizer-name");
  ...
  #Me(t) {
    if (this.#Yt) for (const e of this.#Yt) e.tabIndex = t;
  }
...
class MurmurHash3_64 {
  ...
  hexdigest() {
    let t = this.h1,
      e = this.h2;
    t ^= e >>> 1;
    t = ((3981806797 * t) & pt) | ((36045 * t) & gt);
    e =
      ((4283543511 * e) & pt) |
      (((2950163797 * ((e << 16) | (t >>> 16))) & pt) >>> 16);
    t ^= e >>> 1;
    t = ((444984403 * t) & pt) | ((60499 * t) & gt);
    e =
      ((3301882366 * e) & pt) |
      (((3120437893 * ((e << 16) | (t >>> 16))) & pt) >>> 16);
    t ^= e >>> 1;
    return (
...
const mt = Object.freeze({ map: null, hash: "", transfer: void 0 });
class AnnotationStorage {
  ...
  getValue(t, e) {
    const i = this.#Fe.get(t);
    return void 0 === i ? e : Object.assign(e, i);
  }
  getRawValue(t) {
    return this.#Fe.get(t);
  }
  remove(t) {
    this.#Fe.delete(t);
    0 === this.#Fe.size && this.resetModified();
  ...
  has(t) {
    return this.#Fe.has(t);
  }
  getAll() {
    return this.#Fe.size > 0 ? objectFromMap(this.#Fe) : null;
  }
  setAll(t) {
  ...
  get serializable() {
    if (0 === this.#Fe.size) return mt;
    const t = new Map(),
      e = new MurmurHash3_64(),
      i = [],
      s = Object.create(null);
    let n = !1;
    for (const [i, a] of this.#Fe) {
    ...
    return t.size > 0 ? { map: t, hash: e.hexdigest(), transfer: i } : mt;
  }
  get editorStats() {
    let t = null;
    const e = new Map();
    for (const i of this.#Fe.values()) {
...
class PrintAnnotationStorage extends AnnotationStorage {
  ...
  constructor(t) {
    ...
    this.#Re = { map: n, hash: i, transfer: s };
  }
  get print() {
...
class FontLoader {
  ...
  _prepareFontLoadEvent(t, e) {
    ...
    const c = `@font-face {font-family:"${o}";src:${`url(data:font/opentype;base64,${btoa(
      l
    )});`}}`;
    this.insertRule(c);
...
class BaseCanvasFactory {
  ...
  create(t, e) {
    ...
    return {
      canvas: i,
      context: i.getContext("2d", { willReadFrequently: !this.#Le }),
    };
  }
  reset(t, e, i) {
...
class CanvasExtraState {
  ...
  getPathBoundingBox(t = At, e = null) {
  ...
  getClippedPathBoundingBox(t = At, e = null) {
...
const Et = ["butt", "round", "square"],
  Ct = ["miter", "round", "bevel"],
  St = {},
  Tt = {};
class CanvasGraphics {
  ...
  _createMaskCanvas(t) {
    ...
    const x = Util.transform(getCurrentTransformInverse(v), [
      1,
      0,
      0,
      1,
    ...
    v.fillStyle = a ? n.getPattern(e, this, x, At) : n;
    v.fillRect(0, 0, i, s);
    if (o && !a) {
  ...
  setLineCap(t) {
    this.ctx.lineCap = Et[t];
  }
  setLineJoin(t) {
    this.ctx.lineJoin = Ct[t];
  }
  setMiterLimit(t) {
  ...
  fill(t = !0) {
    ...
    if (this.current.patternFill) {
      e.save();
      e.fillStyle = i.getPattern(e, this, getCurrentTransformInverse(e), At);
      s = !0;
    }
  ...
  paintImageMaskXObjectGroup(t) {
    ...
    for (const n of t) {
      ...
      h.fillStyle = s
        ? i.getPattern(h, this, getCurrentTransformInverse(e), At)
        : i;
      h.fillRect(0, 0, a, r);
      h.restore();
      e.save();
  ...
  consumePath(t) {
    ...
    const i = this.ctx;
    if (this.pendingClip) {
      e || (this.pendingClip === Tt ? i.clip("evenodd") : i.clip());
      this.pendingClip = null;
    }
...
class MessageHandler {
  ...
  #Ue({ data: t }) {
    ...
    if (t.callback) {
      ...
      if (t.callback === Mt) i.resolve(t.data);
      else {
        if (t.callback !== kt) throw new Error("Unexpected callback case");
    ...
    } else t.streamId ? this.#We(t) : e(t.data);
  }
  on(t, e) {
    ...
    const e = t.streamId,
      ...
      o = {
        enqueue(t, a = 1, r) {
          ...
          n.postMessage(
            { sourceName: i, targetName: s, stream: Rt, streamId: e, chunk: t },
            r
          );
        },
        close() {
...
class Metadata {
  ...
  getAll() {
    return objectFromMap(this.#Ve);
  }
  has(t) {
    return this.#Ve.has(t);
  }
}
const Bt = Symbol("INTERNAL");
class OptionalContentGroup {
  ...
  get visible() {
    if (this.#Ke) return this.#Ye;
    if (!this.#Ye) return !1;
    const { print: t, view: e } = this.usage;
    return this.#qe
      ? "OFF" !== e?.viewState
      : !this.#Xe || "OFF" !== t?.printState;
  }
  _setVisible(t, e, i = !1) {
    t !== Bt && unreachable("Internal method `_setVisible` called.");
    this.#Ke = i;
    this.#Ye = e;
  }
}
class OptionalContentConfig {
  ...
  constructor(t, e = r) {
    ...
    if (null !== t) {
      ...
      for (const i of t.groups)
        this.#Je.set(i.id, new OptionalContentGroup(e, i));
      if ("OFF" === t.baseState)
        for (const t of this.#Je.values()) t._setVisible(Bt, !1);
      for (const e of t.on) this.#Je.get(e)._setVisible(Bt, !0);
      for (const e of t.off) this.#Je.get(e)._setVisible(Bt, !1);
  ...
  isVisible(t) {
    ...
    if ("OCG" === t.type) {
      ...
      return this.#Je.get(t.id).visible;
    }
    if ("OCMD" === t.type) {
    ...
    if (s) {
      if (i && e && s.rbGroups.length)
        for (const e of s.rbGroups)
          for (const i of e)
            i !== t && this.#Je.get(i)?._setVisible(Bt, !1, !0);
      s._setVisible(Bt, !!e, !0);
      this.#Qe = null;
  ...
  getGroups() {
    return this.#Je.size > 0 ? objectFromMap(this.#Je) : null;
  }
  getGroup(t) {
...
class PDFFetchStreamRangeReader {
  constructor(t, e, i) {
    ...
    fetch(
      ...
      .then((t) => {
        if (!validateResponseStatus(t.status))
          throw createResponseStatusError(t.status, a);
...
class PDFNetworkStreamFullRequestReader {
  ...
  _onHeadersReceived() {
    const t = this._fullRequestId,
      ...
      { allowRangeRequests: s, suggestedLength: n } =
        validateRangeRequestCapabilities({
          responseHeaders: i,
...
class TextLayer {
  ...
  constructor({ textContentSource: t, container: e, viewport: i }) {
    if (t instanceof ReadableStream) this.#mi = t;
    else {
      if ("object" != typeof t)
        throw new Error('No "textContentSource" parameter specified.');
      this.#mi = new ReadableStream({
        start(e) {
          e.enqueue(t);
          e.close();
        },
  ...
  render() {
    const pump = () => {
      this.#hi.read().then(({ value: t, done: e }) => {
        if (e) this.#ii.resolve();
        else {
          this.#ai ??= t.lang;
          Object.assign(this.#pi, t.styles);
          this.#Ci(t.items);
          pump();
        }
      }, this.#ii.reject);
    };
    this.#hi = this.#mi.getReader();
    TextLayer.#_i.add(this);
    pump();
  ...
  update({ viewport: t, onBefore: e = null }) {
    ...
    if (s !== this.#ci) {
      e?.();
      this.#ci = s;
      setLayerDimensions(this.#di, { rotation: s });
    }
    if (i !== this.#ui) {
      e?.();
      this.#ui = i;
      const t = { div: null, properties: null, ctx: TextLayer.#Si(this.#ai) };
      for (const e of this.#fi) {
        t.properties = this.#bi.get(e);
        t.div = e;
        this.#Ti(t);
      }
    }
  ...
  #Ci(t) {
    if (this.#si) return;
    this.#ri.ctx ??= TextLayer.#Si(this.#ai);
    const e = this.#fi,
      i = this.#gi;
    for (const s of t) {
      if (e.length > 1e5) {
  ...
  #Mi(t) {
    ...
    this.#fi.push(e);
    const s = Util.transform(this.#Ai, t.transform);
    ...
    const c = "calc(var(--scale-factor)*",
      u = e.style;
    if (this.#ut === this.#di) {
      u.left = `${((100 * h) / this.#li).toFixed(2)}%`;
      u.top = `${((100 * d) / this.#oi).toFixed(2)}%`;
    } else {
      u.left = `${c}${h.toFixed(2)}px)`;
      u.top = `${c}${d.toFixed(2)}px)`;
    }
    u.fontSize = `${c}${(TextLayer.#xi * o).toFixed(2)}px)`;
    u.fontFamily = r;
    i.fontSize = o;
  ...
  static #Ei() {
    ...
    this.#xi = t.getBoundingClientRect().height;
    t.remove();
  }
  static #ki(t, e) {
    ...
    if (i) return i;
    const s = this.#Si(e);
    s.canvas.width = s.canvas.height = zt;
    this.#Pi(s, zt, t);
    ...
    s.strokeStyle = "red";
    s.clearRect(0, 0, zt, zt);
    s.strokeText("g", 0, 0);
    let o = s.getImageData(0, 0, zt, zt).data;
    r = 0;
    ...
    s.clearRect(0, 0, zt, zt);
    s.strokeText("A", 0, zt);
    o = s.getImageData(0, 0, zt, zt).data;
    a = 0;
    for (let t = 0, e = o.length; t < e; t += 4)
      if (o[t] > 0) {
        a = zt - Math.floor(t / 4 / zt);
        break;
      }
    s.canvas.width = s.canvas.height = 0;
    const l = a ? a / (a + r) : 0.8;
...
const Ut = 65536,
  ...
  Gt = e
    ...
    : class DOMFilterFactory extends BaseFilterFactory {
        ...
        get #Bi() {
          if (!this.#Ri) {
            const t = this.#Li.createElement("div"),
              { style: e } = t;
            e.visibility = "hidden";
            e.contain = "strict";
            e.width = e.height = 0;
            ...
            e.top = e.left = 0;
            e.zIndex = -1;
            const i = this.#Li.createElementNS(ct, "svg");
            i.setAttribute("width", 0);
            i.setAttribute("height", 0);
            this.#Ri = this.#Li.createElementNS(ct, "defs");
            t.append(i);
            i.append(this.#Ri);
            this.#Li.body.append(t);
          }
          return this.#Ri;
        }
        #Hi(t) {
        ...
        #zi(t) {
          ...
          return `url(${this.#Fi}#${t})`;
        }
        addFilter(t) {
          if (!t) return "none";
          let e = this.#w.get(t);
          if (e) return e;
          const [i, s, n] = this.#Hi(t),
          ...
          const r = `g_${this.#Ii}_transfer_map_${this.#v++}`,
            o = this.#zi(r);
          this.#w.set(t, o);
          this.#w.set(a, o);
          const l = this.#Ui(r);
        ...
        addHCMFilter(t, e) {
          ...
          const l = o.join(","),
            h = `g_${this.#Ii}_hcm_filter`,
            d = (n.filter = this.#Ui(h));
          this.#ji(l, l, l, d);
          this.#Gi(d);
          const getSteps = (t, e) => {
            const i = a[t] / 255,
          ...
          this.#ji(getSteps(0, 5), getSteps(1, 5), getSteps(2, 5), d);
          n.url = this.#zi(h);
          return n.url;
        }
        addAlphaFilter(t) {
          ...
          const n = `g_${this.#Ii}_alpha_map_${this.#v++}`,
            a = this.#zi(n);
          this.#w.set(t, a);
          this.#w.set(s, a);
          const r = this.#Ui(n);
        ...
        addLuminosityFilter(t) {
          ...
          const n = `g_${this.#Ii}_luminosity_map_${this.#v++}`,
            a = this.#zi(n);
          this.#w.set(t, a);
          this.#w.set(i, a);
          const r = this.#Ui(n);
        ...
        addHighlightHCMFilter(t, e, i, s, n) {
          ...
          const getSteps = (t, e, i) => {
            ...
            p = `g_${this.#Ii}_hcm_${t}_filter`,
            g = (r.filter = this.#Ui(p));
          this.#Gi(g);
          this.#ji(
            getSteps(c[0], u[0], 5),
            getSteps(c[1], u[1], 5),
        ...
        destroy(t = !1) {
          if (!t || 0 === this.#Ni.size) {
            if (this.#Ri) {
              this.#Ri.parentNode.parentNode.remove();
              this.#Ri = null;
            }
            if (this.#Di) {
              this.#Di.clear();
        ...
        #$i(t) {
          const e = this.#Li.createElementNS(ct, "feColorMatrix");
        ...
        #Ui(t) {
          const e = this.#Li.createElementNS(ct, "filter");
        ...
        #qi(t, e, i) {
          const s = this.#Li.createElementNS(ct, e);
          s.setAttribute("type", "discrete");
          s.setAttribute("tableValues", i);
          t.append(s);
        }
        #ji(t, e, i, s) {
          const n = this.#Li.createElementNS(ct, "feComponentTransfer");
          s.append(n);
          this.#qi(n, "feFuncR", t);
          this.#qi(n, "feFuncG", e);
          this.#qi(n, "feFuncB", i);
        ...
        #Vi(t, e) {
          const i = this.#Li.createElementNS(ct, "feComponentTransfer");
          e.append(i);
          this.#qi(i, "feFuncA", t);
        }
        #Wi(t) {
          this.#Bi.style.color = t;
          return getRGB(getComputedStyle(this.#Bi).getPropertyValue("color"));
        }
      },
  Vt = e
...
function getDocument(t = {}) {
  ...
  const u = t.verbosity,
    ...
    _ =
      "boolean" == typeof t.isChrome
        ? t.isChrome
        : !util_FeatureTest.platform.isFirefox &&
          "undefined" != typeof window &&
          !!window?.chrome,
    E = Number.isInteger(t.canvasMaxAreaInBytes) ? t.canvasMaxAreaInBytes : -1,
    C = "boolean" == typeof t.disableFontFace ? t.disableFontFace : e,
    S = !0 === t.fontExtraProperties,
    T = !0 === t.enableXfa,
    ...
    D = !0 === t.pdfBug,
    R = t.CanvasFactory || jt,
    I = t.FilterFactory || Gt,
    L = !0 === t.enableHWA,
    O = h ? h.length : t.length ?? NaN,
    N = "boolean" == typeof t.useSystemFonts ? t.useSystemFonts : !e && !C,
    B =
  ...
  setVerbosityLevel(u);
  const H = {
    canvasFactory: new R({ ownerDocument: M, enableHWA: L }),
    filterFactory: new I({ docId: s, ownerDocument: M }),
  ...
  const z = {
    ...
    U = {
      ...
      pdfBug: D,
      styleElement: null,
      loadingParams: { disableAutoFetch: F, enableXfa: T },
    };
  c.promise
    .then(function () {
...
class PDFDocumentLoadingTask {
  ...
  constructor() {
    ...
    this._worker = null;
    this.docId = "d" + PDFDocumentLoadingTask.#Ii++;
    this.destroyed = !1;
...
class PDFPageProxy {
  ...
  render({
    ...
    const complete = (t) => {
        ...
        (this._maybeCleanupAfterRender || b) && (this.#Ki = !0);
        this.#Qi(!b);
        if (t) {
  ...
  #Qi(t = !1) {
    this.#Yi();
    if (!this.#Ki || this.destroyed) return !1;
    if (t) {
      this.#Xi = setTimeout(() => {
        this.#Xi = null;
        this.#Qi(!1);
...
class PDFWorker {
  ...
  constructor({
    ...
    if (e) {
      if (PDFWorker.#is?.has(e))
        throw new Error("Cannot use more than one PDFWorker per port.");
      (PDFWorker.#is ||= new WeakMap()).set(e, this);
  ...
  destroy() {
    ...
    PDFWorker.#is?.delete(this._port);
    this._port = null;
...
class WorkerTransport {
  ...
  setupMessageHandler() {
    ...
    t.on("PasswordRequest", (t) => {
      this.#hs = Promise.withResolvers();
      if (e.onPassword) {
        const updatePassword = (t) => {
          t instanceof Error
            ? this.#hs.reject(t)
            : this.#hs.resolve({ password: t });
        };
        try {
      ...
      } else this.#hs.reject(new PasswordException(t.message, t.code));
      return this.#hs.promise;
    });
    t.on("DataLoaded", (t) => {
  ...
  getPage(t) {
    ...
    const s = this.messageHandler
      ...
      .then((i) => {
        ...
        i.refStr && this.#ls.set(i.refStr, t);
  ...
  getFieldObjects() {
    return this.#ds("GetFieldObjects");
  }
  hasJSActions() {
    return this.#ds("HasJSActions");
  }
  getCalculationOrderIds() {
  ...
  getDocJSActions() {
    return this.#ds("GetDocJSActions");
  }
  getPageJSActions(t) {
  ...
  getOptionalContentConfig(t) {
    return this.#ds("GetOptionalContentConfig").then(
  ...
  cachedPageNumber(t) {
    ...
    return this.#ls.get(e) ?? null;
  }
}
const $t = Symbol("INITIAL_DATA");
class PDFObjects {
  #cs = Object.create(null);
  #us(t) {
    return (this.#cs[t] ||= { ...Promise.withResolvers(), data: $t });
  }
  get(t, e = null) {
    if (e) {
      const i = this.#us(t);
  ...
  clear() {
    for (const t in this.#cs) {
      const { data: e } = this.#cs[t];
      e?.bitmap?.close();
    }
...
class InternalRenderTask {
  ...
  initializeGraphics({ transparency: t = !1, optionalContentConfig: e }) {
    ...
    if (this._canvas) {
      if (InternalRenderTask.#ms.has(this._canvas))
        throw new Error(
          "Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed."
        );
      InternalRenderTask.#ms.add(this._canvas);
    }
  ...
  cancel(t = null, e = 0) {
    ...
    this.gfx?.endDrawing();
    if (this.#gs) {
      window.cancelAnimationFrame(this.#gs);
      this.#gs = null;
    }
    InternalRenderTask.#ms.delete(this._canvas);
    this.callback(
      t ||
...
class AnnotationElement {
  ...
  updateEdited(t) {
    ...
    this.#fs ||= { rect: this.data.rect.slice(0) };
    const { rect: e } = t;
    e && this.#vs(e);
    this.#As?.popup.updateEdited(t);
  }
  resetEdited() {
    if (this.#fs) {
      this.#vs(this.#fs.rect);
      this.#As?.popup.resetEdited();
      this.#fs = null;
    }
  }
  #vs(t) {
  ...
  _createContainer(t) {
    ...
    this instanceof WidgetAnnotationElement || (n.tabIndex = Kt);
    const { style: a } = n;
  ...
  _createPopup() {
    const { data: t } = this,
      e = (this.#As = new PopupAnnotationElement({
        data: {
          color: t.color,
          titleObj: t.titleObj,
  ...
  _getElementsByName(t, e = null) {
    ...
    for (const s of document.getElementsByName(t)) {
      ...
      n !== e && Yt.has(s) && i.push({ id: n, exportValue: t, domElement: s });
    }
    return i;
  }
  show() {
...
class LinkAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    if (t.url) {
      ...
      this.#ys(i, t.attachment, t.attachmentDest);
      s = !0;
    } else if (t.setOCGState) {
      this.#ws(i, t.setOCGState);
      s = !0;
    } else if (t.dest) {
...
class PopupElement {
  ...
  constructor({
    ...
    this.#Os = h;
    this.#Is = i;
    this.#Rs = PDFDateString.toDateObject(n);
    ...
    for (const t of this.trigger) {
      ...
      t.addEventListener("mouseleave", this.#Cs);
      t.classList.add("popupTriggerArea");
    }
    for (const t of i) t.container?.addEventListener("keydown", this.#_s);
    this.#ut.hidden = !0;
    d && this.#Ps();
  }
  render() {
    ...
    t.className = "popup";
    if (this.#Fs) {
      const e = (t.style.outlineColor = Util.makeHexColor(...this.#Fs));
      if (
        ...
        t.style.backgroundColor = Util.makeHexColor(
          ...this.#Fs.map((t) => Math.floor(e * (255 - t) + t))
        );
      }
    }
    const e = document.createElement("span");
    ...
    if (this.#Rs) {
      ...
      t.setAttribute(
        "data-l10n-args",
        JSON.stringify({ dateObj: this.#Rs.valueOf() })
      );
      e.append(t);
    }
    const s = this.#Ws;
    if (s) {
      ...
      const e = this._formatContents(this.#Ds);
      t.append(e);
    }
    this.#ut.append(t);
  }
  ...
  get #Gs() {
    return this.#Ws?.attributes?.style?.fontSize || 0;
  }
  get #Vs() {
    return this.#Ws?.attributes?.style?.color || null;
  }
  #$s(t) {
    const e = [],
      i = {
  ...
  #Es(t) {
    t.altKey ||
      ...
      t.ctrlKey ||
      t.metaKey ||
      (("Enter" === t.key || ("Escape" === t.key && this.#Ns)) && this.#Ps());
  }
  updateEdited({ rect: t, popupContent: e }) {
    this.#fs ||= { contentsObj: this.#Ds, richText: this.#zs };
    t && (this.#S = null);
    if (e) {
      this.#zs = this.#$s(e);
      this.#Ds = null;
  ...
  resetEdited() {
    if (this.#fs) {
      ({ contentsObj: this.#Ds, richText: this.#zs } = this.#fs);
      this.#fs = null;
      this.#Bs?.remove();
      this.#Bs = null;
      this.#S = null;
  ...
  #Ps() {
    ...
    if (this.#Ns) {
      ...
      this.#ut.addEventListener("keydown", this.#_s);
    } else {
      this.#Ss();
      this.#ut.removeEventListener("click", this.#ks);
      this.#ut.removeEventListener("keydown", this.#_s);
    }
  }
  #Ms() {
    this.#Bs || this.render();
    if (this.isVisible) this.#Ns && this.#ut.classList.add("focused");
    else {
      this.#qs();
      this.#ut.hidden = !1;
  ...
  #Ss() {
    ...
    if (!this.#Ns && this.isVisible) {
      this.#ut.hidden = !0;
      this.#ut.style.zIndex = parseInt(this.#ut.style.zIndex) - 1e3;
    }
  }
  forceHide() {
    this.#js = this.isVisible;
    this.#js && (this.#ut.hidden = !0);
  }
  maybeShow() {
    if (this.#js) {
      this.#Bs || this.#Ms();
...
class LineAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      n = (this.#Xs = this.svgFactory.createElement("svg:line"));
...
class SquareAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      a = (this.#Ks = this.svgFactory.createElement("svg:rect"));
...
class CircleAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      s = this.svgFactory.create(e, i, !0),
      n = t.borderStyle.width,
      a = (this.#Ys = this.svgFactory.createElement("svg:ellipse"));
  ...
  render() {
    ...
    if (e.hasAppearance || 0 === e.fillAlpha) i = document.createElement("div");
      ...
      i.src = `${this.imageResourcesPath}annotation-${
        /paperclip/i.test(e.name) ? "paperclip" : "pushpin"
      }.svg`;
      e.fillAlpha &&
        e.fillAlpha < 1 &&
...
class AnnotationLayer {
  ...
  async #an(t, e) {
    ...
    this.div.append(t);
    this.#en?.moveElementInDOM(this.div, t, i, !1);
  }
  async render(t) {
...
class FreeTextEditor extends AnnotationEditor {
  ...
  constructor(t) {
    ...
    this.#Gs = t.fontSize || FreeTextEditor._defaultFontSize;
  }
  static initialize(t, e) {
  ...
  get propertiesToUpdate() {
    return [
      [m.FREETEXT_SIZE, this.#Gs],
      [m.FREETEXT_COLOR, this.#Fs],
    ];
  }
  #dn(t) {
    const setFontsize = (t) => {
  ...
  #cn(t) {
    const setColor = (t) => {
        this.#Fs = this.editorDiv.style.color = t;
      },
      e = this.#Fs;
    this.addCommands({
  ...
  getInitialTranslation() {
    ...
    return [
      ...
      -(FreeTextEditor._internalPadding + this.#Gs) * t,
    ];
  }
  rebuild() {
    if (this.parent) {
  ...
  enableEditMode() {
    ...
    this.#hn = new AbortController();
    const t = this._uiManager.combinedSignal(this.#hn);
  ...
  disableEditMode() {
    if (this.isInEditMode()) {
      ...
      this.div.setAttribute("aria-activedescendant", this.#ln);
      this._isDraggable = !0;
      this.#hn?.abort();
      this.#hn = null;
  ...
  render() {
    ...
    this.editorDiv.setAttribute("id", this.#ln);
  ...
  editorDivPaste(t) {
    ...
    t.preventDefault();
    const s = FreeTextEditor.#fn(e.getData("text") || "").replaceAll(Qt, "\n");
    if (!s) return;
    ...
    if (r.nodeType === Node.TEXT_NODE) {
      ...
      h.push(r.nodeValue.slice(o).replaceAll(Qt, ""));
      if (t !== this.editorDiv) {
        let e = l;
        for (const i of this.editorDiv.childNodes)
          i !== t ? e.push(FreeTextEditor.#gn(i)) : (e = h);
      }
      l.push(r.nodeValue.slice(0, o).replaceAll(Qt, ""));
  ...
  static async deserialize(t, e, i) {
    ...
    n.#Gs = t.fontSize;
    n.#Fs = Util.makeHexColor(...t.color);
    n.#on = FreeTextEditor.#fn(t.value);
  ...
  serialize(t = !1) {
    ...
    const e = FreeTextEditor._internalPadding * this.parentScale,
      ...
      s = AnnotationEditor._colorManager.convert(
        this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#Fs
      ),
      n = {
        annotationType: g.FREETEXT,
        color: s,
    ...
    if (t) return n;
    if (this.annotationElementId && !this.#An(n)) return null;
...
class FreeDrawOutliner {
  ...
  static #Dn = 8;
  static #Rn = 2;
  static #In = FreeDrawOutliner.#Dn + FreeDrawOutliner.#Rn;
  constructor({ x: t, y: e }, i, s, n, a, r = 0) {
    this.#vn = i;
    this.#Pn = n * s;
    this.#xn = a;
    this.#En.set([NaN, NaN, NaN, NaN, t, e], 6);
    this.#wn = r;
    this.#Mn = FreeDrawOutliner.#Dn * s;
    this.#Tn = FreeDrawOutliner.#In * s;
    this.#kn = s;
    this.#Fn.push(t, e);
  }
  isEmpty() {
    return isNaN(this.#En[8]);
  }
  #Ln() {
    const t = this.#En.subarray(4, 6),
      e = this.#En.subarray(16, 18),
      [i, s, n, a] = this.#vn;
    return [
      (this.#Cn + (t[0] - e[0]) / 2 - i) / n,
      (this.#Sn + (t[1] - e[1]) / 2 - s) / a,
      (this.#Cn + (e[0] - t[0]) / 2 - i) / n,
  ...
  add({ x: t, y: e }) {
    ...
    let [r, o, l, h] = this.#En.subarray(8, 12);
    const d = t - l,
      c = e - h,
      u = Math.hypot(d, c);
    ...
    const v = m / p,
      y = (-f / p) * this.#Pn,
      w = v * this.#Pn;
    this.#En.set(this.#En.subarray(2, 8), 0);
    this.#En.set([l + y, h + w], 4);
    this.#En.set(this.#En.subarray(14, 18), 12);
    this.#En.set([l - y, h - w], 16);
    if (isNaN(this.#En[6])) {
      if (0 === this.#_n.length) {
        this.#En.set([r + y, o + w], 2);
        this.#_n.push(NaN, NaN, NaN, NaN, (r + y - i) / n, (o + w - s) / a);
        this.#En.set([r - y, o - w], 14);
        this.#yn.push(NaN, NaN, NaN, NaN, (r - y - i) / n, (o - w - s) / a);
      }
      this.#En.set([b, A, r, o, l, h], 6);
      return !this.isEmpty();
    }
    this.#En.set([b, A, r, o, l, h], 6);
    if (Math.abs(Math.atan2(A - o, b - r) - Math.atan2(f, m)) < Math.PI / 2) {
      [r, o, l, h] = this.#En.subarray(2, 6);
      this.#_n.push(
        NaN,
        NaN,
        NaN,
      ...
      [r, o, b, A] = this.#En.subarray(14, 18);
      this.#yn.push(
        NaN,
        NaN,
        NaN,
    ...
    [b, A, r, o, l, h] = this.#En.subarray(0, 6);
    this.#_n.push(
      ((b + 5 * r) / 6 - i) / n,
      ((A + 5 * o) / 6 - s) / a,
      ((5 * r + l) / 6 - i) / n,
    ...
    [l, h, r, o, b, A] = this.#En.subarray(12, 18);
    this.#yn.push(
      ((b + 5 * r) / 6 - i) / n,
      ((A + 5 * o) / 6 - s) / a,
      ((5 * r + l) / 6 - i) / n,
  ...
  toSVGPath() {
    ...
    const t = this.#_n,
      e = this.#yn;
    if (isNaN(this.#En[6]) && !this.isEmpty()) return this.#On();
    const i = [];
    i.push(`M${t[4]} ${t[5]}`);
  ...
  #On() {
    const [t, e, i, s] = this.#vn,
      [n, a, r, o] = this.#Ln();
    return `M${(this.#En[2] - t) / i} ${(this.#En[3] - e) / s} L${
      (this.#En[4] - t) / i
    } ${(this.#En[5] - e) / s} L${n} ${a} L${r} ${o} L${
      (this.#En[16] - t) / i
    } ${(this.#En[17] - e) / s} L${(this.#En[14] - t) / i} ${
      (this.#En[15] - e) / s
    } Z`;
  }
  #Bn(t) {
  ...
  #Nn(t) {
    const [e, i, s, n] = this.#vn,
      a = this.#En.subarray(4, 6),
      r = this.#En.subarray(16, 18),
      [o, l, h, d] = this.#Ln();
    t.push(
      `L${(a[0] - e) / s} ${(a[1] - i) / n} L${o} ${l} L${h} ${d} L${
        (r[0] - e) / s
      } ${(r[1] - i) / n}`
    );
  }
  ...
  getOutlines() {
    const t = this.#_n,
      ...
      i = this.#En,
      [s, n, a, r] = this.#vn,
      o = new Float64Array((this.#Fn?.length ?? 0) + 2);
    for (let t = 0, e = o.length - 2; t < e; t += 2) {
      o[t] = (this.#Fn[t] - s) / a;
      o[t + 1] = (this.#Fn[t + 1] - n) / r;
    }
    o[o.length - 2] = (this.#Cn - s) / a;
    o[o.length - 1] = (this.#Sn - n) / r;
    if (isNaN(i[6]) && !this.isEmpty()) return this.#Hn(o);
    const l = new Float64Array(this.#_n.length + 24 + this.#yn.length);
    let h = t.length;
    for (let e = 0; e < h; e += 2)
  ...
  #zn(t, e) {
    const i = this.#En.subarray(4, 6),
      s = this.#En.subarray(16, 18),
      [n, a, r, o] = this.#vn,
      [l, h, d, c] = this.#Ln();
    t.set(
      [
...
class FreeDrawOutline extends Outline {
  ...
  constructor(t, e, i, s, n, a) {
    ...
    this.#xn = a;
    this.#Gn(a);
    const { x: r, y: o, width: l, height: h } = this.#jn;
  ...
  toSVGPath() {
    const t = [`M${this.#Wn[4]} ${this.#Wn[5]}`];
    for (let e = 6, i = this.#Wn.length; e < i; e += 6)
      isNaN(this.#Wn[e])
        ? t.push(`L${this.#Wn[e + 4]} ${this.#Wn[e + 5]}`)
        : t.push(
            `C${this.#Wn[e]} ${this.#Wn[e + 1]} ${this.#Wn[e + 2]} ${
              this.#Wn[e + 3]
            } ${this.#Wn[e + 4]} ${this.#Wn[e + 5]}`
          );
    t.push("Z");
    return t.join(" ");
  }
  serialize([t, e, i, s], n) {
    ...
    switch (n) {
      case 0:
        o = this.#Vn(this.#Wn, t, s, a, -r);
        l = this.#Vn(this.#Fn, t, s, a, -r);
        break;
      case 90:
        o = this.#$n(this.#Wn, t, e, a, r);
        l = this.#$n(this.#Fn, t, e, a, r);
        break;
      case 180:
        o = this.#Vn(this.#Wn, i, e, -a, r);
        l = this.#Vn(this.#Fn, i, e, -a, r);
        break;
      case 270:
        o = this.#$n(this.#Wn, i, s, -a, -r);
        l = this.#$n(this.#Fn, i, s, -a, -r);
    }
  ...
  #Gn(t) {
    ...
    const c = n - this.#wn,
      ...
      p = r - n + 2 * this.#wn,
      g = o - a + 2 * this.#wn;
    this.#jn = { x: c, y: u, width: p, height: g, lastPoint: [l, h] };
  }
  get box() {
    return this.#jn;
  }
  ...
  getNewOutline(t, e) {
    const { x: i, y: s, width: n, height: a } = this.#jn,
      ...
      p = s * h + o,
      g = this.newOutliner(
        { x: this.#Fn[0] * d + u, y: this.#Fn[1] * c + p },
        this.#vn,
        this.#kn,
        t,
        this.#xn,
    ...
    for (let t = 2; t < this.#Fn.length; t += 2)
      g.add({ x: this.#Fn[t] * d + u, y: this.#Fn[t + 1] * c + p });
...
class HighlightOutliner {
  ...
  constructor(t, e = 0, i = 0, s = !0) {
    ...
    this.#vn = { x: c, y: u, width: h, height: d, lastPoint: g };
  }
  getOutlines() {
  ...
  #Jn(t) {
    ...
    return new HighlightOutline(s, this.#vn);
  }
  #Zn(t) {
    const e = this.#Xn;
    let i = 0,
  ...
  #Yn([, t, e]) {
    const i = this.#Zn(t);
    this.#Xn.splice(i, 0, [t, e]);
  }
  #Qn([, t, e]) {
    const i = this.#Zn(t);
    for (let s = i; s < this.#Xn.length; s++) {
      const [i, n] = this.#Xn[s];
      if (i !== t) break;
      if (i === t && n === e) {
        this.#Xn.splice(s, 1);
...
class ColorPicker {
  ...
  constructor({ editor: t = null, uiManager: e = null }) {
    if (t) {
      this.#ra = !1;
      this.#ha = m.HIGHLIGHT_COLOR;
      this.#a = t;
    } else {
      this.#ra = !0;
      this.#ha = m.HIGHLIGHT_DEFAULT_COLOR;
    }
    this.#m = t?._uiManager || e;
    this.#oa = this.#m._eventBus;
    this.#sa =
      t?.color || this.#m?.highlightColors.values().next().value || "#FFFF98";
    ColorPicker.#da ||= Object.freeze({
  ...
  renderButton() {
    ...
    t.addEventListener("click", this.#ca.bind(this), { signal: e });
    t.addEventListener("keydown", this.#Es.bind(this), { signal: e });
  ...
  #ua() {
    ...
    for (const [i, s] of this.#m.highlightColors) {
      ...
      n.title = i;
      n.setAttribute("data-l10n-id", ColorPicker.#da[i]);
  ...
  _moveToPrevious(t) {
    if (t.target !== this.#na?.firstChild && t.target !== this.#ea) {
      this.#ga || this.#ca(t);
      t.target.previousSibling?.focus();
    } else this.#ga && this._hideDropdownFromKeyboard();
  }
  _moveToBeginning(t) {
    this.#ga ? this.#na.firstChild?.focus() : this.#ca(t);
  }
  _moveToEnd(t) {
    this.#ga ? this.#na.lastChild?.focus() : this.#ca(t);
  }
  #Es(t) {
  ...
  #ca(t) {
    ...
    this.#aa = 0 === t.detail;
    if (!this.#la) {
      this.#la = new AbortController();
      window.addEventListener("pointerdown", this.#h.bind(this), {
        signal: this.#m.combinedSignal(this.#la),
      });
    }
    if (this.#na) {
      this.#na.classList.remove("hidden");
      return;
    }
  ...
  updateColor(t) {
    this.#ia && (this.#ia.style.backgroundColor = t);
    if (!this.#na) return;
...
class HighlightEditor extends AnnotationEditor {
  ...
  constructor(t) {
    ...
    this.#Pn = t.thickness || HighlightEditor._defaultThickness;
    this.#Sa = t.opacity || HighlightEditor._defaultOpacity;
    ...
    if (t.highlightId > -1) {
      ...
      this.#ma = t.anchorNode;
      this.#fa = t.anchorOffset;
      this.#ya = t.focusNode;
  ...
  get telemetryInitialData() {
    return {
      action: "added",
      type: this.#Ea ? "free_highlight" : "highlight",
  ...
  #Da() {
    const t = new HighlightOutliner(this.#ba, 0.001);
    this.#_a = t.getOutlines();
    ({
      x: this.x,
      y: this.y,
      width: this.width,
    ...
    this.#va = e.getOutlines();
    const { lastPoint: i } = this.#va.box;
    this.#Ca = [(i[0] - this.x) / this.width, (i[1] - this.y) / this.height];
  }
  #Pa({ highlightOutlines: t, highlightId: e, clipPathId: i }) {
    this.#_a = t;
    this.#va = t.getNewOutline(this.#Pn / 2 + 1.5, 0.0025);
    if (e >= 0) {
      this.#v = e;
      this.#Aa = i;
      this.parent.drawLayer.finalizeLine(e, t);
      this.#Ta = this.parent.drawLayer.drawOutline(this.#va);
    } else if (this.parent) {
      const e = this.parent.viewport.rotation;
      this.parent.drawLayer.updateLine(this.#v, t);
      this.parent.drawLayer.updateBox(
        this.#v,
        HighlightEditor.#Ra(this.#_a.box, (e - this.rotation + 360) % 360)
      );
      this.parent.drawLayer.updateLine(this.#Ta, this.#va);
      this.parent.drawLayer.updateBox(
        this.#Ta,
        HighlightEditor.#Ra(this.#va.box, e)
      );
    }
    ...
    const { lastPoint: o } = this.#va.box;
    this.#Ca = [(o[0] - s) / a, (o[1] - n) / r];
  }
  static initialize(t, e) {
    AnnotationEditor.initialize(t, e);
  ...
  get propertiesToUpdate() {
    return [
      ...
      [m.HIGHLIGHT_THICKNESS, this.#Pn || HighlightEditor._defaultThickness],
      [m.HIGHLIGHT_FREE, this.#Ea],
    ];
  }
  #cn(t) {
  ...
  fixAndSetPosition() {
    return super.fixAndSetPosition(this.#Oa());
  }
  getBaseTranslation() {
    return [0, 0];
  }
  getRect(t, e) {
    return super.getRect(t, e, this.#Oa());
  }
  onceAdded() {
  ...
  #La(t) {
    if (!this.#Ea) return;
    this.#Pa({ highlightOutlines: this.#_a.getNewOutline(t / 2) });
    this.fixAndSetPosition();
  ...
  #Fa(t = this.parent) {
    if (null === this.#v) {
      ({ id: this.#v, clipPathId: this.#Aa } = t.drawLayer.draw(
        this.#_a,
        this.color,
        this.#Sa
      ));
      this.#Ta = t.drawLayer.drawOutline(this.#va);
      this.#xa && (this.#xa.style.clipPath = this.#Aa);
    }
  }
  static #Ra({ x: t, y: e, width: i, height: s }, n) {
    switch (n) {
      case 90:
  ...
  rotate(t) {
    ...
    if (this.#Ea) {
      ...
      i = HighlightEditor.#Ra(this.#_a.box, t);
    } else i = HighlightEditor.#Ra(this, t);
    e.rotate(this.#v, t);
    e.rotate(this.#Ta, t);
    e.updateBox(this.#v, i);
    e.updateBox(this.#Ta, HighlightEditor.#Ra(this.#va.box, t));
  }
  render() {
    if (this.div) return this.div;
    const t = super.render();
    if (this.#Ma) {
      t.setAttribute("aria-label", this.#Ma);
    ...
    const e = (this.#xa = document.createElement("div"));
    t.append(e);
    e.setAttribute("aria-hidden", "true");
    e.className = "internal";
    e.style.clipPath = this.#Aa;
    const [i, s] = this.parentDimensions;
    this.setDims(this.width * i, this.height * s);
    bindEvents(this, this.#xa, ["pointerover", "pointerleave"]);
    this.enableEditing();
    return t;
  }
  pointerover() {
  ...
  #Ha(t) {
    ...
    t ? e.setPosition(this.#ma, this.#fa) : e.setPosition(this.#ya, this.#wa);
  }
  select() {
    super.select();
    if (this.#Ta) {
  ...
  #Oa() {
    return this.#Ea ? this.rotation : 0;
  }
  #za() {
  ...
  #Ua(t) {
    return this.#_a.serialize(t, this.#Oa());
  }
  static startHighlighting(t, e, { target: i, x: s, y: n }) {
    ...
    i.addEventListener("pointermove", this.#Wa.bind(this, t), { signal: d });
  ...
  static async deserialize(t, e, i) {
    ...
    if (a) {
      ...
      const t = r[0],
        i = { x: t[0] - c, y: d - (t[1] - u) },
        s = new FreeHighlightOutliner(i, [0, 0, h, d], 1, l.#Pn / 2, !0, 0.001);
  ...
  serialize(t = !1) {
    ...
    if (this.annotationElementId && !this.#An(s)) return null;
...
class InkEditor extends AnnotationEditor {
  ...
  #pr(t, e) {
    ...
    const i = this._uiManager.combinedSignal(this.#Ka);
    ...
    this.#ir = () => {
      this.#gr();
      this.#ir && window.requestAnimationFrame(this.#ir);
    };
  ...
  #mr(t, e) {
    ...
    if (n.length <= 2) {
      ...
      if (3 === n.length) {
        this.#qa = a = new Path2D();
        a.moveTo(...n[0]);
      }
      this.#fr(a, ...n.at(-3), ...n.at(-2), t, e);
    }
  }
  #br() {
  ...
  #Ar(t, e) {
    ...
    this.#br();
    let i;
    if (1 !== this.currentPath.length) i = this.#vr();
    else {
      const s = [t, e];
  ...
  canvasPointerdown(t) {
    if (0 === t.button && this.isInEditMode() && !this.#Xa) {
      this.setInForeground();
      t.preventDefault();
      this.div.contains(document.activeElement) ||
        this.div.focus({ preventScroll: !0 });
  ...
  #Tr(t, e, i, s) {
    ...
    for (const e of this.paths) {
      ...
      n.push({
        bezier: InkEditor.#Cr(i, s, this.rotation),
        points: InkEditor.#Cr(a, s, this.rotation),
      });
    }
    return n;
  }
  ...
  #_r() {
    return this.#Xa ? Math.ceil(this.thickness * this.parentScale) : 0;
  }
  #nr(t = !1) {
    if (this.isEmpty()) return;
    if (!this.#Xa) {
    ...
    const e = this.#Mr(),
      i = this.#_r();
    this.#Va = Math.max(AnnotationEditor.MIN_SIZE, e[2] - e[0]);
    this.#Ga = Math.max(AnnotationEditor.MIN_SIZE, e[3] - e[1]);
  ...
  static async deserialize(t, e, i) {
    ...
    const p = s.#Mr();
    s.#Va = Math.max(AnnotationEditor.MIN_SIZE, p[2] - p[0]);
    s.#Ga = Math.max(AnnotationEditor.MIN_SIZE, p[3] - p[1]);
    s.#xr(r, o);
    return s;
  }
  serialize() {
...
class StampEditor extends AnnotationEditor {
  ...
  #Ur() {
    ...
    if (this.#Dr) {
      ...
      this.#Dr = null;
      this._uiManager.enableWaiting(!0);
      this.#Fr = this._uiManager.imageManager
        .getFromUrl(t)
        .then((t) => this.#Hr(t))
        .finally(() => this.#zr());
      return;
  ...
  rebuild() {
    if (this.parent) {
      super.rebuild();
      if (null !== this.div) {
        this.#Pr && null === this.#Lr && this.#Ur();
        this.isAttachedToDOM || this.parent.add(this);
      }
    } else this.#Pr && this.#Ur();
  }
  onceAdded() {
    this._isDraggable = !0;
    this.div.focus();
  ...
  isEmpty() {
    return !(this.#Fr || this.#kr || this.#Dr || this.#Rr || this.#Pr);
  }
  get isResizable() {
    return !0;
  }
  ...
  #rr() {
    ...
    this._uiManager.enableWaiting(!1);
    const l = (this.#Lr = document.createElement("canvas"));
    ...
    this.#Ir && l.setAttribute("aria-label", this.#Ir);
  }
  copyCanvas(t, e, i = !1) {
    t || (t = 224);
  ...
  #Gr(t, e) {
    ...
    this._initialOptions = null;
    null !== this.#Or && clearTimeout(this.#Or);
    this.#Or = setTimeout(() => {
      this.#Or = null;
      this.#jr(t, e);
    }, 200);
  ...
  #jr(t, e) {
    ...
    a.width = s;
    a.height = n;
    const r = this.#Nr ? this.#kr : this.#Wr(s, n),
      o = a.getContext("2d");
  ...
  #Vr(t) {
    if (t) {
      ...
      t.getContext("2d").drawImage(this.#kr, 0, 0);
      return t.toDataURL();
    }
    if (this.#Nr) {
      const [t, e] = this.pageDimensions,
...
class AnnotationEditorLayer {
  ...
  disable() {
    ...
    for (const t of AnnotationEditorLayer.#z.values())
  ...
  enableTextSelection() {
    this.div.tabIndex = -1;
    if (this.#to?.div && !this.#eo) {
      this.#eo = new AbortController();
      const t = this.#m.combinedSignal(this.#eo);
  ...
  #so(t) {
    ...
    if (
      ...
      this.#to.div.addEventListener(
        "pointerup",
        () => {
          this.#to.div.classList.remove("free");
  ...
  enableClick() {
    if (this.#Xr) return;
    this.#Xr = new AbortController();
    const t = this.#m.combinedSignal(this.#Xr);
  ...
  #io() {
    this.#Jr = !0;
    for (const t of this.#Yr.values()) t.isEmpty() && t.remove();
    this.#Jr = !1;
  }
  render({ viewport: t }) {
    this.viewport = t;
  ...
  update({ viewport: t }) {
    ...
    if (e !== i) for (const t of this.#Yr.values()) t.rotate(i);
    this.addInkEditorIfNeeded(!1);
  }
  get pageDimensions() {
...
class DrawLayer {
  ...
  static #ho(t, { x: e = 0, y: i = 0, width: s = 1, height: n = 1 } = {}) {
    const { style: a } = t;
    a.top = 100 * i + "%";
    a.left = 100 * e + "%";
    a.width = 100 * s + "%";
  ...
  updatePath(t, e) {
    this.#lo.get(t).setAttribute("d", e.toSVGPath());
  }
  updateBox(t, e) {
    DrawLayer.#ho(this.#oo.get(t), e);
  }
  show(t, e) {
...
var Jt = __webpack_exports__.AbortException,
  Zt = __webpack_exports__.AnnotationEditorLayer,
  te = __webpack_exports__.AnnotationEditorParamsType,
  ee = __webpack_exports__.AnnotationEditorType,
  ie = __webpack_exports__.AnnotationEditorUIManager,
  se = __webpack_exports__.AnnotationLayer,
  ne = __webpack_exports__.AnnotationMode,
  ae = __webpack_exports__.ColorPicker,
  re = __webpack_exports__.DOMSVGFactory,
  oe = __webpack_exports__.DrawLayer,
  le = __webpack_exports__.FeatureTest,
  he = __webpack_exports__.GlobalWorkerOptions,
  de = __webpack_exports__.ImageKind,
  ce = __webpack_exports__.InvalidPDFException,
  ue = __webpack_exports__.MissingPDFException,
  pe = __webpack_exports__.OPS,
  ge = __webpack_exports__.OutputScale,
  me = __webpack_exports__.PDFDataRangeTransport,
  fe = __webpack_exports__.PDFDateString,
  be = __webpack_exports__.PDFWorker,
  Ae = __webpack_exports__.PasswordResponses,
  ve = __webpack_exports__.PermissionFlag,
  ye = __webpack_exports__.PixelsPerInch,
  we = __webpack_exports__.RenderingCancelledException,
  xe = __webpack_exports__.TextLayer,
  _e = __webpack_exports__.UnexpectedResponseException,
  Ee = __webpack_exports__.Util,
  Ce = __webpack_exports__.VerbosityLevel,
  Se = __webpack_exports__.XfaLayer,
  Te = __webpack_exports__.build,
  Me = __webpack_exports__.createValidAbsoluteUrl,
  ke = __webpack_exports__.fetchData,
  Pe = __webpack_exports__.getDocument,
  Fe = __webpack_exports__.getFilenameFromUrl,
  De = __webpack_exports__.getPdfFilenameFromUrl,
  Re = __webpack_exports__.getXfaPageViewport,
  Ie = __webpack_exports__.isDataScheme,
  Le = __webpack_exports__.isPdfFile,
  Oe = __webpack_exports__.noContextMenu,
  Ne = __webpack_exports__.normalizeUnicode,
  Be = __webpack_exports__.setLayerDimensions,
  He = __webpack_exports__.shadow,
  ze = __webpack_exports__.version;
export {
  Jt as AbortException,
  Zt as AnnotationEditorLayer,
  te as AnnotationEditorParamsType,
  ee as AnnotationEditorType,
  ie as AnnotationEditorUIManager,
  se as AnnotationLayer,
  ne as AnnotationMode,
  ae as ColorPicker,
  re as DOMSVGFactory,
  oe as DrawLayer,
  le as FeatureTest,
  ...
  de as ImageKind,
  ce as InvalidPDFException,
  ue as MissingPDFException,
  pe as OPS,
  ge as OutputScale,
  me as PDFDataRangeTransport,
  fe as PDFDateString,
  be as PDFWorker,
  Ae as PasswordResponses,
  ve as PermissionFlag,
  ye as PixelsPerInch,
  we as RenderingCancelledException,
  xe as TextLayer,
  _e as UnexpectedResponseException,
  Ee as Util,
  Ce as VerbosityLevel,
  Se as XfaLayer,
  Te as build,
  Me as createValidAbsoluteUrl,
  ke as fetchData,
  Pe as getDocument,
  Fe as getFilenameFromUrl,
  De as getPdfFilenameFromUrl,
  Re as getXfaPageViewport,
  Ie as isDataScheme,
  Le as isPdfFile,
  Oe as noContextMenu,
  Ne as normalizeUnicode,
  Be as setLayerDimensions,
  He as shadow,
  ze as version,
};
