...
def process_pdf_first_page(pdf_path, vendor_list, output_dir="output"):
...
# 已知的供应商列表
known_vendors = [
    "B&R", "UNICA", "XIAMEN", "SMART POUER", "ABB", "SCHNEIDER"
]

# 使用示例
pdf_path = r"E:\tool\pdm\1111\SM20180809A GENERAL ARRANGEMENT V01.pdf"  # 替换为您的PDF路径
result, vendor, tag_info = process_pdf_first_page(pdf_path, known_vendors)